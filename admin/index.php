...
<form method="get" action="index.php">
    <nav class="navbar navbar-expand navbar-dark bg-primary">
        <a class="navbar-brand" href="../index.php">Vanilla</a>
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="../index.php">Početna</a>
            </li>
            <li>
                <button class="btn btn-primary btn-block" type="submit" name="submit" value="listproducts">LIST PRODUCTS</button>
            </li>
            <li>
                <button class="btn btn-primary btn-block" type="submit" name="submit" value="insertproducts">INSERT PRODUCT</button>
            </li>
            <li>
                <button class="btn btn-primary btn-block" type="submit" name="submit" value="listorders">LIST ORDERS</button>
            </li>
        </ul>
    </nav>
</form>
